...
class OwnerDateSelection extends StatefulWidget {
  const OwnerDateSelection({ super.key });

  @override
  State<OwnerDateSelection> createState() => _YellowBirdState();
}

class _YellowBirdState extends State<OwnerDateSelection> {
  @override
                  ...
                  if (_selectedDay != null) {
                    ...
                    print(formattedDate);
                       Navigator.push(
                                    ...
                                    OwnerHomepage(selectedDate: formattedDate,)));
                  }
                },
