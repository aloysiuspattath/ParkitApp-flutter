...
import 'package:parkapp/userslot_deletion.dart';
import 'package:table_calendar/table_calendar.dart';

class DeleteDateSelection extends StatefulWidget {
  final String userid;
  const DeleteDateSelection({Key? key, required this.userid}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _DeleteDateSelectionState createState() => _DeleteDateSelectionState();
}

class _DeleteDateSelectionState extends State<DeleteDateSelection> {
                  ...
                  if (_selectedDay != null ) {
                    ...
                    print(formattedDate);
                       Navigator.push(
                                    ...
                                    UserSlotDeletion(userid: widget.userid,date: formattedDate,)));
                  }
                },
